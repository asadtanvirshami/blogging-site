            ...
            <div className="container main-top mt-5">
              <div className="row ">
                <div className="col-md-6 ban-div pt-5 ">
                  <h1 className="ban-h mb-4 ">Welcome to BlogNow.</h1>

                  <p className="ban-txt ">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Non
                    explicabo nihil exercitationem minima mollitia autem et
                    ducimus laborum eius tenetur optio est, sit, quasi excepturi
                    rem necessitatibus inventore aliquam saepe. Lorem ipsum
                    dolor sit amet consectetur adipisicing elit. Aliquam,
                    reiciendis. Maxime eligendi asperiores distinctio mollitia.
                    Distinctio beatae veniam atque? Aliquam provident voluptatem
                    minus, unde atque sint rem quasi ipsa labore?
                  </p>
      ...
      {bogList.map((bg, index) => {
        return (
          <div key={index} className="my-5">
            <div
              className="blogs-div container col-md-7 mx-auto p-4 justify-content-center"
              key={index}
            >
              <img src={bg.pfpUser} width={50} height={50} />
              <h3>{bg.postedBy}</h3>
              <img src={bg.blogcover} height={100} />
              <h3>{bg.postedBy}</h3>
              <h2>{bg.blogtitle}</h2>
              <p> {parse(`${bg.posts}`)}</p>
              <Form.Text muted>
