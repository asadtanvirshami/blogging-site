...
export const ApprovalsPage = () => {
    ...
    useEffect(() => {
        let res = axios.get(process.env.NEXT_PUBLIC_FP_GET_APPROVALS).then((res) => {
    ...
    const Approved = (id, e) => {
        e.preventDefault();
        axios.post(process.env.NEXT_PUBLIC_FP_POST_STATUS, {
            id: id
        }).then((res) => {
    ...
    const DeleteBlog = (id, e) => {
        ...
        axios.delete(process.env.NEXT_PUBLIC_FP_DELETE_BLOG, {
                ...
                Aprv.map((bit, i) => {
                    return (
                        <Form key={i} >
                            ...
                            <Form.Group className="" style={{ color: "black" }} controlId="formBasicEmail">
                            ...
                            <Button variant="primary" onClick={(e) => { DeleteBlog(bit.id, e) }}>
                            ...
                            <br></br>
                             <br></br>
                            <div><Button onClick={(e) => { Approved(bit.id, e) }}>Approve</Button></div>
                        </Form>
                    )
                })}
